...
public extension Tensor where N == Float16 {
  typealias MathBlockF16 = (_ feature: [Scalar]) -> Scalar
   ...
   */
  func apply(axis: Int, _ block: MathBlockF16) -> Tensor<N> {
    let shape = shape
  ...
  func sumOfSquares(axis: Int = -1) -> Tensor<N> {
    let block: MathBlockF16 = { feature in
...
extension Array where Element == Tensor<Float16> {
  
  var mean: Tensor<Float16> {
  ...
  func gradients(_ deltas: [Tensor<Float16>]) -> [Tensor<Float16>.Gradient] {
    var result = [Tensor<Float16>.Gradient](repeating: .init(),
                                      count: deltas.count)
  ...
  static func +(lhs: [Tensor<Float16>], rhs: [Tensor<Float16>]) -> Self {
    var result: [Tensor<Float16>] = []
  ...
  static func *(lhs: [Tensor<Float16>], rhs: Tensor<Float16>.Scalar) -> Self {
    var result: [Tensor<Float16>] = []
...
public extension Tensor<Float16>.Gradient {
  static func applyMultiple(lhs: Tensor<Float16>.Gradient,
                            rhs: Tensor<Float16>.Gradient,
                            block: (_ lhs: [Tensor<Float16>], _ rhs: [Tensor<Float16>]) -> [Tensor<Float16>]) -> Tensor<Float16>.Gradient {
    //(input: [Tensor<Float16>], weights: [Tensor<Float16>], biases: [Tensor<Float16>])
    let input = block(lhs.input, rhs.input)
    let weight = block(lhs.weights, rhs.weights)
    let bias = block(lhs.biases, rhs.biases)
    return Tensor<Float16>.Gradient(input: input, weights: weight, biases: bias)
  }
  
  static func applyScalar(lhs: Tensor<Float16>.Gradient,
                          rhs: Tensor<Float16>.Scalar,
                          block: (_ lhs: [Tensor<Float16>], _ rhs: Tensor<Float16>.Scalar) -> [Tensor<Float16>]) -> Tensor<Float16>.Gradient {
    //(input: [Tensor<Float16>], weights: [Tensor<Float16>], biases: [Tensor<Float16>])
  ...
  static func /(lhs: Tensor<Float16>.Gradient, rhs: Tensor<Float16>.Gradient) -> Tensor<Float16>.Gradient {
  ...
  static func +(lhs: Tensor<Float16>.Gradient, rhs: Tensor<Float16>.Scalar) -> Tensor<Float16>.Gradient {
